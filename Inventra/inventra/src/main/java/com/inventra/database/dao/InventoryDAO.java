...
public class InventoryDAO {
    ...
    public List<ProductInventoryDTO> getProductInventoryDTOByLocation(int locationId) throws SQLException {
        ...
        String sql = "SELECT " +
                ...
                "JOIN locations l ON i.location_id = l.location_id WHERE i.location_id = ?";
        try (Connection conn = DBConnection.getConnectionToDatabase();
                PreparedStatement stmt = conn.prepareStatement(sql)) {
            stmt.setInt(1, locationId);
            ResultSet rs = stmt.executeQuery();
